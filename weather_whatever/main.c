...
struct Weather *filter_by_date(struct Weather *data, int size, time_t start, time_t end, int *result_size); // to do
void draw_temperature_chart(struct Weather *data, int size); // to do 
void free_weather_data(struct Weather *data); // to do

void print_all_test(struct Weather *data,int size);// test prototype
